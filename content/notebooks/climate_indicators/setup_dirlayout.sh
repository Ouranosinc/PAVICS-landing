...
NOTEBOOK_OUTDIR_BASE="/notebook_dir/writable-workspace/tmp"
mkdir -p $NOTEBOOK_OUTDIR_BASE
unzip $THIS_DIR/tutorial3.zip -d $NOTEBOOK_OUTDIR_BASE/
unzip $THIS_DIR/tutorial5.zip -d $NOTEBOOK_OUTDIR_BASE/
